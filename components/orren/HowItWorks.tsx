...
export default function LeadGenHowItWorks() {
  return (
    <section id="how-it-works" className="py-20 md:py-32 bg-gray-50 text-black">
            ...
            <AnimateOnScroll key={index} delay={index * 0.1}>
              <div className="flex flex-col md:flex-row gap-6 items-start">
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 rounded-full bg-gray-800 text-white flex items-center justify-center">
