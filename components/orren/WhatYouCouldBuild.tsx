...
export default function WhatYouCouldBuild() {
  return (
    <section id="what-you-could-build" className="py-20 md:py-32 bg-gray-50 text-black">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
          {examples.map((example, index) => (
            <AnimateOnScroll key={index} delay={index * 0.05}>
              <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-gray-400 transition-colors h-full flex flex-col">
                <example.icon className="w-10 h-10 text-gray-900 mb-4" />
