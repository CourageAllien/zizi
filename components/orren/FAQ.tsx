...
export default function LeadGenFAQ() {
  ...
  return (
    <section id="faq" className="py-20 md:py-32 bg-gray-50 text-black">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-4 text-left flex items-center justify-between text-gray-900 hover:text-gray-700 transition-colors"
                >
