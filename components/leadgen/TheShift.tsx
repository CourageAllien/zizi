...
export default function TheShift() {
  return (
    <section id="the-shift" className="py-20 md:py-32 bg-[var(--color-bg-secondary)]">
      <div className="max-w-4xl mx-auto px-6">
        <AnimateOnScroll>
          ...
          <p className="text-xl md:text-2xl font-semibold text-white mb-8 text-center">
          ...
          <div className="bg-[var(--color-bg-primary)] border border-[var(--color-primary)]/30 rounded-2xl p-8 mt-12">
            ...
            <p className="text-xl font-semibold text-[var(--color-primary)] mt-4">
              Not anymore.
            </p>
          </div>
        </AnimateOnScroll>
