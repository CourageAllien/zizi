...
export default function TheShift() {
  return (
    <section id="the-shift" className="py-20 md:py-32 bg-white text-black">
      <div className="max-w-4xl mx-auto px-6">
        <AnimateOnScroll>
          ...
          <p className="text-xl md:text-2xl font-semibold text-black mb-8 text-center">
          ...
          <div className="bg-gray-100 border border-gray-300 rounded-2xl p-8 mt-12">
