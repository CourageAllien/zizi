...
const BENEFITS = [
  {
    icon: Target,
    text: "Discuss your marketing & sales goals and campaigns",
  },
  {
    icon: Zap,
    text: "Learn what AI-powered assets we'd build for you",
  },
  {
    icon: Rocket,
    text: "See how the trial-to-partnership model works",
  },
];
...
export default function PartnerBookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/partner/book", {
        method: "POST",
        headers: {
  ...
  if (isConfirmed) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center px-4">
        <div className="fixed inset-0 bg-gradient-to-br from-green-950/30 via-[#0a0a0a] to-emerald-950/20 pointer-events-none" />
        <motion.div
        ...
        >
          ...
          <p className="text-gray-400 mb-6">
            ...
            Looking forward to discussing how we can help with your sales and marketing campaigns.
          </p>
          ...
          <a
            href="/partner"
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#22c55e] text-white rounded-xl font-medium hover:bg-[#16a34a] transition-colors"
          >
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden">
      <div className="fixed inset-0 bg-gradient-to-br from-green-950/30 via-[#0a0a0a] to-emerald-950/20 pointer-events-none" />
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[#22c55e]/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-12">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white via-green-200 to-[#22c55e] bg-clip-text text-transparent">
            Let&apos;s Talk About Your Campaigns
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            We&apos;ll discuss your current marketing and sales initiatives, and show you
            how AI-powered assets can accelerate your conversions and revenue.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          >
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-900/40 border border-gray-800/50 rounded-2xl p-6 backdrop-blur-sm">
              <h3 className="text-lg font-semibold mb-4 text-[#22c55e]">
              ...
              <ul className="space-y-4">
                {BENEFITS.map((benefit, index) => (
                  ...
                  >
                    <div className="p-2 rounded-lg bg-[#22c55e]/10 text-[#22c55e] mt-0.5">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#22c55e]/10 to-transparent border border-[#22c55e]/20 rounded-2xl p-6"
            >
              <h4 className="font-semibold text-white mb-2">Our Model</h4>
              <p className="text-gray-400 text-sm mb-4">
                Start with a <span className="text-[#22c55e] font-medium">$750 trial build</span> to 
                see our work, then optionally become a partner at{" "}
                <span className="text-[#22c55e] font-medium">$2,500/month</span> for unlimited builds.
              </p>
              <p className="text-xs text-gray-500">No commitments. Cancel anytime.</p>
            </motion.div>
          </motion.div>
                ...
                {step === "calendar" ? (
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            required
                            className="w-full px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700 focus:border-[#22c55e] focus:ring-1 focus:ring-[#22c55e] transition-colors outline-none"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-400 mb-2">
                          What campaigns or sales initiatives are you currently working on? *
                        </label>
                        <textarea
                          ...
                          required
                          rows={3}
                          className="w-full px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700 focus:border-[#22c55e] focus:ring-1 focus:ring-[#22c55e] transition-colors outline-none resize-none"
                          placeholder="e.g., Product launch, lead gen campaign, sales outreach..."
                        />
                      </div>

                      <div>
                        <label className="block text-sm font-medium text-gray-400 mb-2">
                          What would make this partnership a win for you?{" "}
                        ...
                        <textarea
                          ...
                          rows={2}
                          className="w-full px-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700 focus:border-[#22c55e] focus:ring-1 focus:ring-[#22c55e] transition-colors outline-none resize-none"
                          placeholder="e.g., 2x qualified leads, faster sales cycles..."
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="w-full py-4 rounded-xl bg-gradient-to-r from-[#22c55e] to-[#16a34a] text-white font-semibold flex items-center justify-center gap-2 hover:from-[#16a34a] hover:to-[#15803d] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isSubmitting ? (
                          <>
        ...
        >
          <div className="text-2xl font-bold bg-gradient-to-r from-[#22c55e] to-[#4ade80] bg-clip-text text-transparent">
            ZiziCo
          </div>
          <p className="text-sm text-gray-500 mt-1">Your AI Sales & Marketing Partner</p>
        </motion.div>
      </div>
    </div>
  );
